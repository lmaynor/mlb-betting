  ...
  return (
    <section style={{ borderBottom: B }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,7fr) minmax(0,5fr)' }}>
        ...
        <div style={{ padding: '40px 20px 32px', borderRight: B }}>
          ...
          <h1 style={{ fontSize: 'clamp(24px, 3.2vw, 38px)', fontWeight: 600, lineHeight: 1.12, letterSpacing: '-0.02em', color: 'var(--text)', marginBottom: '12px' }}>
