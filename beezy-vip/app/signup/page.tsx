    ...
    return (
      <div style={{ minHeight: '70vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '64px 16px' }}>
        <div style={{ width: '100%', maxWidth: '440px', textAlign: 'center' }}>
          <p className="dell-heading" style={{ fontSize: '10px', letterSpacing: '0.1em', color: 'var(--fog)', marginBottom: '16px' }}>Pre-Launch</p>
          <h1 className="dell-display" style={{ fontSize: '22px', color: 'var(--ash)', marginBottom: '16px' }}>
            Join the Waitlist
          </h1>
          <p style={{ fontSize: '13px', color: 'var(--silver)', lineHeight: 1.65, marginBottom: '28px', maxWidth: '360px', margin: '0 auto 28px' }}>
          ...
          <div style={{ border: B, padding: '20px', textAlign: 'left' }}>
            <p className="dell-heading" style={{ fontSize: '9px', letterSpacing: '0.1em', color: 'var(--fog)', marginBottom: '16px' }}>
              ...
              return (
                <div key={s.system} style={{ marginBottom: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '5px' }}>
                    <span className="mono" style={{ fontSize: '10px', color: 'var(--silver)' }}>{s.system}</span>
                    <span className="mono" style={{ fontSize: '10px', color: 'var(--fog)' }}>{count}/200</span>
                  </div>
                  <div style={{ height: '2px', background: 'var(--basalt)' }}>
