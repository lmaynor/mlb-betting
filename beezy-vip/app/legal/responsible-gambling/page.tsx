...
export const metadata: Metadata = { title: 'Responsible Gambling — Beezy.VIP' }
...
export default function LegalPage() {
  return (
    <div style={{ maxWidth: '760px', margin: '0 auto', padding: '40px 20px' }}>
      ...
      <h1 style={{ fontSize: '20px', fontWeight: 600, color: '#f5f5f7', marginBottom: '24px' }}>Responsible Gambling</h1>
