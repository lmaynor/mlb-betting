...
function headshotUrl(name: string | null): string | null {
  ...
  // Prefer local bg-removed PNG (generated by scripts/process_headshots.py)
  const localPath = path.join(PUBLIC_DIR, 'headshots', `${key}.png`)
  if (fs.existsSync(localPath)) return `/headshots/${key}.png`

  // Fall back to MLB CDN
